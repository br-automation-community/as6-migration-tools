        ...
        while idx < len(state_lines):
            ...
            while idx < len(state_lines):
                ...
                while idx < len(state_lines):
                    ...
                    converted_line, _, did_convert = _convert_next_line(state_lines[idx])
                    if did_convert:
                ...
                while idx < len(state_lines) and not when_prefix.match(state_lines[idx]):
            ...
            def _infer_indent_unit(
                ...
                for candidate in then_lines + else_lines:
                    ...
                    leading_ws = m_ws.group(1) if m_ws else ""
                    if leading_ws.startswith(if_indent) and len(leading_ws) > len(if_indent):
            ...
            def _emit_branch(branch_idx: int, prefix: str = ""):
                ...
                if has_meaningful_else or has_nested:
                    ...
                    indent_unit = _infer_indent_unit(if_indent, then_lines, normalized_else)
